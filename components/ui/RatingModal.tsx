...
const RatingModal: FC<Props> = (props) => {
  ...
  return (
    ...
    >
      <div className="bg-[#f5f5f5] dark:bg-[#1a1919] w-96 py-6 px-8 rounded-lg shadow-lg">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows={4}
            className="w-full px-2 py-3 border rounded-[12px] shadow-[0_1px_2px_0] shadow-gray border-[#CED4DA] dark:bg-black/30 dark:text-white mt-1"
          ></textarea>
        </div>
        ...
        <div className="flex justify-end">
          ...
          <button
            ...
            className="ml-2 px-4 py-2 bg-gray dark:bg-slate-900 text-gray-700 rounded-md hover:bg-gray-400"
          >
            Cancel
          </button>
        </div>
